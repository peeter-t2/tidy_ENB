...
rmarkdown::render("code/overview_ENB_people.Rmd", output_format = "html_document")
file.rename(from="code/overview_ENB_people.html",to="reports/overview_ENB_people.html")
